...
class CatalogActivity : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        series.add(Pelicula("Dr. Who ",R.drawable.drwho,R.drawable.drwho,"Traveling across time and space, the immortal time-lord known as &#39;The Doctor&#39; travels across the\n" +
